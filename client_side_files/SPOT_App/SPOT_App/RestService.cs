    ...
    public class RestService
    {
        ...
        public async Task<List<RequestViewModel>> GetRequestData(int maxNumRowsToGet, int startRowOffset)
        {
            ...
            try
            {
                ...
                {
                   rvm.Email=makeStringContainSomethingNotNull(rvm.Email);
                   rvm.Name=makeStringContainSomethingNotNull(rvm.Name);
                   rvm.OrganizationName=  makeStringContainSomethingNotNull(rvm.OrganizationName);
                   rvm.PrimaryPhoneNumber=  makeStringContainSomethingNotNull(rvm.PrimaryPhoneNumber);
                   rvm.ContactTimes=  makeStringContainSomethingNotNull(rvm.ContactTimes);
                   rvm.PresentationLocation=  makeStringContainSomethingNotNull(rvm.PresentationLocation);
                   rvm.HandsOnActivity=  makeStringContainSomethingNotNull(rvm.HandsOnActivity);
                   rvm.GradeLevels=  makeStringContainSomethingNotNull(rvm.GradeLevels);
                   rvm.NumberOfStudents=  makeStringContainSomethingNotNull(rvm.NumberOfStudents);
                   rvm.ProposedDateAndTime=  makeStringContainSomethingNotNull(rvm.ProposedDateAndTime);
                   rvm.OtherConcerns=  makeStringContainSomethingNotNull(rvm.OtherConcerns);
                   rvm.PreferredDays=  makeStringContainSomethingNotNull(rvm.PreferredDays);
                   rvm.Supplies=  makeStringContainSomethingNotNull(rvm.Supplies);
                   rvm.TravelFee=  makeStringContainSomethingNotNull(rvm.TravelFee);
                    rvm.SubjectRequested = makeStringContainSomethingNotNull(rvm.SubjectRequested);
                    rvm.AmbassadorStatus = makeStringContainSomethingNotNull(rvm.AmbassadorStatus);
                    rvm.PresentationRotations = makeStringContainSomethingNotNull(rvm.PresentationRotations);
                    rvm.PresentationRequested = makeStringContainSomethingNotNull(rvm.PresentationRequested);
        ...
        String makeStringContainSomethingNotNull(String x)
        {
